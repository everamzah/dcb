...
craft_guide.get_craft_guide_formspec = function(meta, search, page, alternate)
	...
	local formspec = "size[14,10;]".. --..default.gui_bg..default.gui_bg_img..default.gui_slots
	...
	formspec=formspec --.."label[0,5;--== Learn to Craft ==--]"
		...
		--.."label[0,5.4;Send to Output]"
		--.."label[0,5.8;craft. Save your favorite items in Bookmarks.]"

		.."field[5.95,5.4;2.3,1;craft_guide_search_box;;"..tostring(search).."]"
		...
		.."button[5,5.1;0.75,1;close_mm;X]" --button_exit
