...
minetest.register_node("mobs:mossycobble_trap", {
...
minetest.register_node("mobs:stone_with_copper_trap", {
...
minetest.register_node("mobs:stone_with_gold_trap", {
...
minetest.register_node("mobs:stone_with_diamond_trap", {
...
minetest.register_node("mobs:molten_gold_source", {
	...
	drowning = 1,
	liquidtype = "source",
	liquid_alternative_flowing = "mobs:molten_gold_flowing",
	liquid_alternative_source = "mobs:molten_gold_source",
	liquid_viscosity = 7,
	liquid_renewable = false,
	liquid_range = 3,
...
minetest.register_node("mobs:molten_gold_flowing", {
