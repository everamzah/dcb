...
if minetest.get_modpath("farming_plus") then
	minetest.register_craft({
		output = 'farming_plus:tomato_item 4',
		recipe = {{"foodblock:tomatoblock"}},
	})
	minetest.register_craft({
		output = 'farming_plus:tomato_item 2',
		recipe = {{"foodblock:tomatoblock_slab"}},
	})
else
	minetest.register_craft({
		output = 'farming:tomato 4',
		recipe = {{"foodblock:tomatoblock"}},
	})
	minetest.register_craft({
		output = 'farming:tomato 2',
		recipe = {{"foodblock:tomatoblock_slab"}},
	})
end
...
minetest.register_craft({
	type = "shapeless",
	output = "farming_plus:tomato_item 5",
	recipe = {"foodblock:tomatoblock" , "farming_plus:tomato_item"},
})
minetest.register_craft({
	type = "shapeless",
	output = "farming_plus:tomato_item 3",
	recipe = {"foodblock:tomatoblock_slab" , "farming_plus:tomato_item"},
})
minetest.register_craft({
	type = "shapeless",
	output = "farming:tomato 5",
	recipe = {"foodblock:tomatoblock" , "farming:tomato"},
})
minetest.register_craft({
	type = "shapeless",
	output = "farming:tomato 3",
...
if minetest.get_modpath("farming_plus") then
	minetest.register_craft({
		output = 'farming_plus:carrot_item 4',
		recipe = {{"foodblock:carrotblock"}},
	})

	minetest.register_craft({
		output = 'farming_plus:carrot_item 2',
		recipe = {{"foodblock:carrotblock_slab"}},
	})
else
	minetest.register_craft({
		output = 'farming:carrot 4',
		recipe = {{"foodblock:carrotblock"}},
	})

	minetest.register_craft({
		output = 'farming:carrot 2',
		recipe = {{"foodblock:carrotblock_slab"}},
	})
end
...
minetest.register_craft({
	type = "shapeless",
	output = "farming_plus:carrot_item 5",
	recipe = {"foodblock:carrotblock" , "farming_plus:carrot_item"},
})
minetest.register_craft({
	type = "shapeless",
	output = "farming_plus:carrot_item 3",
	recipe = {"foodblock:carrotblock_slab" , "farming_plus:carrot_item"},
})
minetest.register_craft({
	type = "shapeless",
	output = "farming:carrot 5",
	recipe = {"foodblock:carrotblock" , "farming:carrot"},
})
minetest.register_craft({
	type = "shapeless",
	output = "farming:carrot_item 3",
