...
HUNGER_MOVE_TICK = 10		-- time in seconds after the movement is checked
...
HUNGER_EXHAUST_MOVE = 0.25 	-- exhaustion increased this value if player movement detected
HUNGER_EXHAUST_LVL = 50		-- at what exhaustion player saturation gets lowered
