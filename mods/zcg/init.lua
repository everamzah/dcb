...
---[[
minetest.register_node("zcg:stupid", {
	description = "Stupid",
	...
	after_place_node = function(pos, placer)
		...
		meta:set_string("formspec", zcg.formspec(player))
		zcg.users[player] = {current_item = "", alt = 1, page = 0, history={index=0,list={}}} 
	end,
	on_rightclick = function(pos, node, clicker, itemstack, pointed_thing)
		minetest.show_formspec("james", "zcg:stupid", zcg.formspec("james"))
	end,
})
--]]
