...
mobs:register_mob("mobs:goblin_cobble", {
	...
	do_custom = function(self)
		...
		"mobs:mossycobble_trap" --replace_with_secondary
		)
	end,
})
mobs:register_egg("mobs:goblin_cobble", "Goblin Egg (cobble)", "default_mossycobble.png", 1)

mobs:register_mob("mobs:goblin_digger", {
...
mobs:register_egg("mobs:goblin_digger", "Goblin Egg (digger)", "default_mossycobble.png", 1)

mobs:register_mob("mobs:goblin_coal", {
	...
	do_custom = function(self)
		...
		"air", --replace_with
		3, --replace_rate_secondary
		"mobs:stone_with_coal_trap" --replace_with_secondary
		)
	end,

})
mobs:register_egg("mobs:goblin_coal", "Goblin Egg (coal)", "default_mossycobble.png", 1)

mobs:register_mob("mobs:goblin_iron", {
	...
	do_custom = function(self)
		...
		"air", --replace_with
		3, --replace_rate_secondary
		"mobs:stone_with_iron_trap" --replace_with_secondary
		)
	end,
})
mobs:register_egg("mobs:goblin_iron", "Goblin Egg (iron)", "default_mossycobble.png", 1)

mobs:register_mob("mobs:goblin_copper", {
	...
	do_custom = function(self)
		...
		"air", --replace_with
		3, --replace_rate_secondary
		"mobs:stone_with_copper_trap" --replace_with_secondary
		)
	end,
})
mobs:register_egg("mobs:goblin_copper", "Goblin Egg (copper)", "default_mossycobble.png", 1)

mobs:register_mob("mobs:goblin_gold", {
	...
	do_custom = function(self)
		...
		"air", --replace_with
		3, --replace_rate_secondary
		"mobs:stone_with_gold_trap" --replace_with_secondary
		)
	end,
})
mobs:register_egg("mobs:goblin_gold", "Goblin Egg (gold)", "default_mossycobble.png", 1)

mobs:register_mob("mobs:goblin_diamond", {
	...
	do_custom = function(self)
		...
		"air", --replace_with
		3, --replace_rate_secondary
		"mobs:stone_with_diamond_trap" --replace_with_secondary
		)
	end,

})
mobs:register_egg("mobs:goblin_diamond", "Goblin Egg (diamond)", "default_mossycobble.png", 1)
...
---[[
mobs:register_spawn("mobs:goblin_cobble", {"group:stone"}, 100, 0, 200000, 4, 0)
mobs:register_spawn("mobs:goblin_digger", {"group:stone"}, 100, 0, 200000, 4, 0)
mobs:register_spawn("mobs:goblin_coal", {"default:stone_with_coal"}, 100, 0, 100000, 3, 0)
mobs:register_spawn("mobs:goblin_iron", {"default:stone_with_iron"}, 100, 0, 100000, 3, -20)
mobs:register_spawn("mobs:goblin_copper", {"default:stone_with_copper","default:mossycobble"}, 100, 0, 100000, 3, -30)
mobs:register_spawn("mobs:goblin_gold", {"default:stone_with_gold" }, 100, 0, 100000, 2, -40)
mobs:register_spawn("mobs:goblin_diamond", {"default:stone_with_diamond"}, 100, 0, 100000, 2, -60)
mobs:register_spawn("mobs:goblin_king", {"default:stone_with_mese","default:mossycobble", }, 100, 0, 200000, 1, -100)
--]]
